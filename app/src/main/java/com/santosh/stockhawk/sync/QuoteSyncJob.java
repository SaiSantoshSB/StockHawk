package com.santosh.stockhawk.sync;
...
public final class QuoteSyncJob {
    ...
    private static final String ACTION_DATA_UPDATED = "com.santosh.stockhawk.ACTION_DATA_UPDATED";
            ...
            while (iterator.hasNext()) {
                ...
                if (stock != null) {
                    ...
                    if (quote.getPrice() != null && quote.getChange() != null && quote.getChangeInPercent() != null) {
                        ...
                        Intent intent = new Intent(NO_STOCK);
