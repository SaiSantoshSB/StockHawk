    ...
    public int onRunTask(TaskParams params) {
        ...
        if (params.getTag().equals("init") || params.getTag().equals("periodic")) {
            ...
            initQueryCursor = mContext.getContentResolver().query(StockProvider.Quotes.CONTENT_URI,
                    new String[]{"Distinct " + StockContract.SYMBOL}, null,
                    null, null);
        ...
        try {
            ...
            try {
                ...
                if (isUpdate) {
                    contentValues.put(StockContract.IS_CURRENT, 0);
                    mContext.getContentResolver().update(StockProvider.Quotes.CONTENT_URI, contentValues,
                            null, null);
                }
                ...
                if (batchOperations != null && batchOperations.size() != 0) {
                    mContext.getContentResolver().applyBatch(StockProvider.AUTHORITY,
                            batchOperations);
                } else {
